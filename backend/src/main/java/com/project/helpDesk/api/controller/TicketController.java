package com.project.helpDesk.api.controller;
...
import com.project.helpDesk.api.dto.Summary;
...
import com.project.helpDesk.api.enums.StatusEnum;
import com.project.helpDesk.api.response.Response;
import com.project.helpDesk.api.security.jwt.JwtTokenUtil;
...
public class TicketController {
	...
	private void validateCreateTicket(Ticket ticket, BindingResult result) {
		if (ticket.getTitle() == null) {
			result.addError(new ObjectError("Ticket", "Titulo do ticket não informado"));
			return;
		}
	}
	...
	public ResponseEntity<Response<Summary>> findChart(HttpServletRequest request) {
		...
		chart.setQuantidadeNovo(quantidadeNovo);
		chart.setQuantidadeResolvido(quantidadeResolvido);
		chart.setQuantidadeAprovado(quantidadeAprovado);
		chart.setQuantidadeReprovado(quantidadeReprovado);
		chart.setQuantidadeAtribuido(quantidadeAtribuido);
		chart.setQuantidadeFechado(quantidadeFechado);
